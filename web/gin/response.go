...
func html(engine *gin.Engine) {
	...
	engine.LoadHTMLFiles("web/static/template.html", "web/static/student.html") //后面可以在go代码直接用template.html和student.html
...
func main() {
	...
	engine.Static("/css", "web/static/css")                     //在url里访问目录/css相当于访问文件系统中的web/static/css目录
