...
// go test -v ./redis -run=^TestStringValue$ -count=1
// go test -v ./redis -run=^TestStructValue$ -count=1
// go test -v ./redis -run=^TestDelete$ -count=1
// go test -v ./redis -run=^TestListValue$ -count=1
// go test -v ./redis -run=^TestSetgValue$ -count=1
// go test -v ./redis -run=^TestZSetValue$ -count=1
// go test -v ./redis -run=^TestHashTableValue$ -count=1
// go test -v ./redis -run=^TestScan$ -count=1
