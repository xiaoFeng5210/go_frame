...
func BenchmarkLoggerSlog(b *testing.B) {
	...
	b.ResetTimer()
	for b.Loop() {
		logger.Info(LOG, "name", "dqq", "age", 18)
...
func BenchmarkLoggerLogrus(b *testing.B) {
	...
	b.ResetTimer()
	for b.Loop() {
		logger.WithFields(logrus.Fields{"name": "dqq", "age": 18}).Info(LOG)
	}
}
...
BenchmarkLoggerSlog-8             263564              4733 ns/op
BenchmarkLoggerLogrus-8           143138              7502 ns/op
BenchmarkLoggerZap-8              298590              3442 ns/op
*/
