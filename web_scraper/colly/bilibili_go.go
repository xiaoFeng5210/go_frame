...
import (
	"bufio"
	"dqq/go/frame/web_scraper/algorithm"
	"log"
	"os"
	"os/signal"
	"regexp"
...
var (
	...
	spiderEntry     = "https://www.bilibili.com/video/BV1cKSxYzEPX/" //爬取的始点
	vedioCreateTime = "2024-06-01"                                   //只爬取vedioCreateTime之后发的视频
)
...
func scrapPage(h *colly.HTMLElement) {
	...
	view := toNumber(dom.Find("div.view-text").Text())
